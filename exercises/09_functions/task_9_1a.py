...
def generate_access_config(intf_vlan_mapping, access_template, psecurity=None,port_security=port_security_template):
    '''
    ...
    for intf,vlan in intf_vlan_mapping.items():
        ...
        for command in access_template:
            if 'vlan' in command:
                res.append(command+' '+str(vlan))
            else: res.append(command)
        if psecurity:
